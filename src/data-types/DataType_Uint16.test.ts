...
import DataType_Uint16 from "./DataType_Uint16"
...
test.each([
  ...
  [64536, new Uint8Array([0xfc, 0x18]).buffer],
])("Encode #%#", (a, expected) => {
  const dt = new DataType_Uint16("test_field")
...
test.each([
  ...
  [new Uint8Array([0xfc, 0x18]).buffer, 64536],
])("Decode #%#", (a, expected) => {
  const dt = new DataType_Uint16("test_field")
